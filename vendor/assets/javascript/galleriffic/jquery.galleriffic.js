  ...
  $.fn.galleriffic = function(settings) {
    ...
    $.extend(this, {
      ...
      buildPager : function(pager) {
        ...
        // Open/close
        // yim custom
        pager.append('<a id="toggleThumbs" href="#toggleThumbs" title="' + this.hideThumbsText + '">' + this.hideThumbsText + '</a>');
        return this;
      },
      ...
      //yim
      //toggles the display of thumbs so the image can be larger
      toggleThumbs : function() {
        $("#thumbs").hide('slide', {
          direction : 'left'
        }, 500, function() {
          //$("#gallery").css("width", "100%");
          //$(".advance-link img").css("width", "150%");

          //$("#gallery").css("width", "100%");

          $("#thumbs").css("float", "none");
          $("#thumbs").css("width", "");

          $("#slideshow span").css("width", "100%");
          $("#slideshow span a").css("width", "100%");
          $("#slideshow span a img").css("width", "90%");
          //$("#slideshow span a img").css("top", "0");
          //$("#slideshow span a img").css("right", "0");

          //$("#slideshow span").removeClass('image-wrapper');
          //$("#slideshow span").addClass('image-wrapper-big');
