/*!
 * tn3 mediaelemnt plugin v1.3.0.52
 * http://tn3gallery.com/
 *
 * License
...
this.tn3.isPlaying){this.tn3WasPlaying=true;this.tn3.isPlaying=false;this.tn3.timer.stop()}},onVideoPause:function(){if(this.tn3.items.play){this.tn3.items.play.removeClass(this.tn3.config.cssID+"-play-active");this.tn3.items.play.attr("title",this.tn3.t("Play Video"))}},onVideoEnd:function(){if(this.tn3WasPlaying){this.tn3.isPlaying=true;this.tn3.show("next")}},resize:function(){if(this.stretch){var a=this.mep;a.width=this.tn3.imager.$c.width();a.height=this.tn3.imager.$c.height();this.mep.container.find("video").attr("width",
